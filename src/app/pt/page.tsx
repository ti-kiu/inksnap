...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Simulador de Tatuagem com IA | InkPreview',
    description: 'Visualize designs de tatuagem no seu corpo com IA antes de tatuar.',
    url: 'https://inkpreview.co/pt',
    siteName: 'InkPreview',
    locale: 'pt_BR',
    type: 'website',
  },
      ...
      <main>
        ...
        <section className="relative bg-warm-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 py-20 md:py-28 text-center">
            ...
            <p className="text-lg md:text-xl text-stone max-w-2xl mx-auto mb-8">
              {t(locale, 'hero.subtitle')}
            </p>
            <Link
              href="/tattoo-simulator"
              className="inline-flex items-center gap-2 bg-sage text-white px-8 py-4 rounded-xl text-lg font-medium hover:bg-sage-dark transition shadow-card"
            >
        ...
        <section className="py-20 bg-sage-light/30 text-center">
          <div className="max-w-2xl mx-auto px-6">
            <h2 className="font-display text-3xl text-ink mb-4">Pronto para experimentar?</h2>
            <p className="text-stone mb-8">Comece gratuitamente. Sem cadastro necessário.</p>
            <Link
              href="/tattoo-simulator"
              className="inline-flex items-center gap-2 bg-sage text-white px-8 py-4 rounded-xl text-lg font-medium hover:bg-sage-dark transition"
            >
              {t(locale, 'nav.try')} →
            </Link>
          </div>
