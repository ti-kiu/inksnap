...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Vorschau von Tattoo-Designs auf Ihrem Körper mit KI.',
    url: 'https://inkpreview.co/de',
    siteName: 'InkPreview',
    locale: 'de_DE',
    type: 'website',
  },
    ...
    <main>
      ...
      <section className="py-20 bg-sage-light/30 text-center">
        <div className="max-w-2xl mx-auto px-6">
          <h2 className="font-display text-3xl text-ink mb-4">Bereit zum Ausprobieren?</h2>
          <p className="text-stone mb-8">Kostenlos starten. Keine Anmeldung erforderlich.</p>
